...
import { TwitterLogoContainer } from "./StyledComponents";
const TwitterLogo = () => {
  const theme = useTheme();

  const twitterSvg = (
    <svg viewBox="0 0 24 24" style={{ height: "40px" }}>
      <path
        fill={theme.primary.accent}
  ...
  return <TwitterLogoContainer to={"/home"}>{twitterSvg}</TwitterLogoContainer>;
};
